...
func SimulateMsgUpdateCollection(
	...
	return func(r *rand.Rand, app *baseapp.BaseApp, ctx sdk.Context, accs []simtypes.Account, chainID string,
		...
		// TODO: Handling the MsgUpdateCollection simulation

		return simtypes.NoOpMsg(types.ModuleName, msg.Type(), "MsgUpdateCollection simulation not implemented"), nil, nil
	}
}
