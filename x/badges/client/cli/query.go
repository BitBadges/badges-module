...
// 	option (google.api.http).get = "/bitbadges/github.com/bitbadges/badges-module/badges/get_approvals_tracker/{collectionId}/{approvalLevel}/{approverAddress}/{amountTrackerId}/{trackerType}/{approvedAddress}";
// }
...
// 	option (google.api.http).get = "/bitbadges/github.com/bitbadges/badges-module/badges/get_num_used_for_challenge/{collectionId}/{approvalLevel}/{approverAddress}/{challengeTrackerId}/{leafIndex}";
// }
