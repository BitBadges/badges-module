...
import (
	...
	badgesmodulekeeper "github.com/bitbadges/badges-module/x/badges/keeper"
	...
	"github.com/bitbadges/badges-module/docs"
)
...
func New(
	...
	if homeDirOpt != nil {
		...
		if overrideHomeDir != "" {
			DefaultNodeHome = overrideHomeDir
		}
	}
	// randomHomeDir := DefaultNodeHome + "/test_" + fmt.Sprint(rand.Int63n(1000000))
